...
include::user-controller-mock-service-test/get-users-list/1/response-fields.adoc[]
...
include::user-controller-mock-service-test/get-users-list/1/curl-request.adoc[]

==== Example response

include::user-controller-mock-service-test/get-users-list/1/http-response.adoc[]
